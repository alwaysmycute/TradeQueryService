-- ============================================================
-- Table: trade_monthly_share_by_countries
-- 各國月度貿易市佔率 — 含金額佔比與重量佔比
-- Source: trade_monthly_by_countries + 自身彙總（台灣月度總額）
-- ============================================================

CREATE OR REPLACE TABLE trade_monthly_share_by_countries AS
WITH monthly_totals AS (
    -- 計算台灣每月每產業的總貿易額/總重量（跨所有國家加總）
    SELECT
        YEAR,
        MONTH,
        TRADE_FLOW,
    ...
    FROM trade_monthly_by_countries
...
FROM trade_monthly_by_countries c
